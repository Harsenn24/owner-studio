            ...
            <section
                ...
                <div v-if="studioNumbers.length" class="grid md:grid-cols-2 gap-4">
                    <div v-for="sn in studioNumbers" :key="sn.id"
                        ...
                        <button class="px-3 py-1 text-sm rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition"
                ...
                <div v-else class="text-center py-10">
                    ...
                    <button class="mt-4 px-4 py-2 bg-green-600! text-white rounded-xl shadow hover:bg-green-700! transition"
