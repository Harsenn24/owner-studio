        ...
        <div
            ...
            <div class="flex flex-col items-center justify-center space-y-4">
                ...
                <h2 class="text-xl font-semibold text-gray-800">
                    Pengajuan studio berhasil dikirim
                </h2>

                <!-- Description -->
                <p class="text-sm text-gray-600">
                    Tim kami akan segera memeriksa pengajuan Anda. Terima kasih telah menggunakan layanan kami.
                </p>

                <!-- Button -->
                <button @click="goHome"
                    class="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200">
                    Tutup
                </button>
            </div>
        </div>
