<template>
    ...
    <div v-else class="min-h-screen flex flex-col bg-gradient-to-b from-white via-gray-50 to-gray-100 p-6">
        ...
        <HeadersPage v-if="shouldFetchData" @open-modal="openModal" @logout="logout" />    
        ...
        <div
            ...
            <div class="text-center mb-10">
                ...
                <div class="mt-2">
                    ...
                    <h3 v-else-if="checkSubmissionStatus === 'rejected'" class="text-2xl font-bold text-red-100">Mohon
                        Maaf,
            ...
            <div class="mt-10 text-center">
                <div class="mb-4">
                    ...
                    <p v-else-if="checkSubmissionStatus === 'rejected'" class="text-sm font-extrabold text-white">
                        Catatan:
                        {{
...
onMounted(async () => {
    try {
        if (shouldFetchData.value) {
            await Promise.all([checkSubmission(), fetchStudio()])
        }
    } finally {
